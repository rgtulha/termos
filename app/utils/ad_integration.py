...
class ADIntegration:
    ...
    def __init__(self):
        ...
        # Atributo correto descoberto anteriormente
    ...
    def _validar_cpf(self, cpf_bruto: str) -> str:
        """
        Realiza a validação completa de um CPF.
        Retorna o CPF FORMATADO (XXX.XXX.XXX-XX) se válido.
        Retorna 'CPF INCORRETO !!!' se inválido.
        """
        ...
        # 2. Remover caracteres não numéricos do CPF para cálculo
        ...
        # 7. Comparar os dígitos calculados com os fornecidos e RETORNAR FORMATADO
        if int(cpf_limpo[9]) == primeiro_digito_calc and \
           int(cpf_limpo[10]) == segundo_digito_calc:
            
            # --- AQUI ESTÁ A CORREÇÃO ---
            # Em vez de retornar cpf_limpo (só números), formatamos com pontos e traço:
    ...
    def search_users(self, partial_name):
        ...
        try:
            ...
            for dn, entry in results:
                ...
                # 1. Pega o valor do atributo correto (Office)
